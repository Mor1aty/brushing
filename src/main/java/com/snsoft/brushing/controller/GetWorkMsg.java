...
import com.snsoft.brushing.service.GetWorkMsgService;
 ...
 * @version: 1.0
 * 
 * @date: Sep 23, 2018 4:43:03 PM
 *
 * @Description: TODO 提交答题信息Controller
 */
@Controller()
public class GetWorkMsg {
	@Resource
	private GetWorkMsgService service;

	@RequestMapping(value = "getWorkMsg.do", method = RequestMethod.POST)
	public void getWorkMsg(HttpServletRequest request, HttpServletResponse response) throws IOException {
		String result = "";
		HashMap<String, String> params = JsonUtil.requestToMap(request);
		result = HttpUtil.checkParams(params, new String[] { "id", "score" });
		// 校验不通过，适用于需要请求参数的情况
